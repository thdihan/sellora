        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title">Edit Sales Target</h3>
                    <div>
                        <a href="{{ route('sales-targets.show', $target) }}" class="btn btn-info me-2">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('sales-targets.update', $target) }}" method="POST">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="card-body">
                                                        ...
                                                        <optgroup label="{{ $roleLevel }}">
                                                            @foreach($employees as $employee)
                                                                <option value="{{ $employee->id }}" 
                                                                    {{ old('assigned_to_user_id', $salesTarget->assigned_to_user_id) == $employee->id ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="target_year" id="target_year" class="form-select" required>
                                                @for($year = date('Y') - 1; $year <= date('Y') + 2; $year++)
                                                    <option value="{{ $year }}" 
                                                        {{ old('target_year', $target->target_year) == $year ? 'selected' : '' }}>
                                                        {{ $year }}
                                                    </option>
                                                @endfor
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="status" id="status" class="form-select">
                                                ...
                                                <option value="inactive" {{ old('status', $target->status) == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                            ...
                                            <div class="col-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="week_1_target" id="week_1_target" 
                                                           ...
                                                           value="{{ old('week_1_target', $target->week_1_target) }}" placeholder="0.00">
                                                </div>
                                            </div>
                                            <div class="col-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="week_2_target" id="week_2_target" 
                                                           class="form-control" step="0.01" min="0" 
                                                           value="{{ old('week_2_target', $target->week_2_target) }}" placeholder="0.00">
                                                </div>
                                            </div>
                                            <div class="col-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="week_3_target" id="week_3_target" 
                                                           class="form-control" step="0.01" min="0" 
                                                           value="{{ old('week_3_target', $target->week_3_target) }}" placeholder="0.00">
                                                </div>
                                            </div>
                                            <div class="col-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="week_4_target" id="week_4_target" 
                                                           class="form-control" step="0.01" min="0" 
                                                           value="{{ old('week_4_target', $target->week_4_target) }}" placeholder="0.00">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3 col-sm-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="{{ $key }}_target" id="{{ $key }}_target" 
                                                       ...
                                                       value="{{ old($key . '_target', $target->{$key . '_target'}) }}" placeholder="0.00">
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="total_yearly_target" id="total_yearly_target" 
                                                   ...
                                                   value="{{ old('total_yearly_target', $target->total_yearly_target) }}" placeholder="0.00">
                                        </div>
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="col-md-6">
                                        <div class="alert alert-info">
                                            ...
                                            <p class="mb-0"><strong>Current Total: ৳<span id="calculated-total">{{ number_format($target->total_yearly_target, 2) }}</span></strong></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <span class="text-muted">{{ $target->created_at->format('M d, Y \\a\\t h:i A') }}</span>
                                    </div>
                                    <div class="col-md-4">
                                        <strong>Last Updated:</strong><br>
                                        <span class="text-muted">{{ $target->updated_at->format('M d, Y \\a\\t h:i A') }}</span>
                                    </div>
                                    <div class="col-md-4">
                                        <strong>Assigned By:</strong><br>
                                        <span class="text-muted">{{ $target->assignedBy->name }} ({{ $target->assignedBy->role->name }})</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('sales-targets.show', $target) }}" class="btn btn-info">
                                <i class="fas fa-eye"></i> View Details
                            </a>
                            <a href="{{ route('sales-targets.index') }}" class="btn btn-secondary">
