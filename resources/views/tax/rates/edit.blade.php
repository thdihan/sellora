        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title mb-0">Edit Tax Rate</h3>
                    <a href="{{ route('rates.show', $taxRate->id) }}" class="btn btn-secondary">
                        <i class="fas fa-arrow-left"></i> Back to Details
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('tax.rates.update', ['tax' => request()->route('tax'), 'rate' => $taxRate->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select @error('tax_code_id') is-invalid @enderror" id="tax_code_id" name="tax_code_id" required>
                                        ...
                                        @foreach($taxCodes as $taxCode)
                                            <option value="{{ $taxCode->id }}" {{ (old('tax_code_id', $taxRate->tax_code_id) == $taxCode->id) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('label') is-invalid @enderror" 
                                           id="label" name="label" value="{{ old('label', $taxRate->label) }}" required 
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('percent') is-invalid @enderror" 
                                           id="percent" name="percent" value="{{ old('percent', $taxRate->percent) }}" required 
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('country') is-invalid @enderror" 
                                           id="country" name="country" value="{{ old('country', $taxRate->country) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('region') is-invalid @enderror" 
                                           id="region" name="region" value="{{ old('region', $taxRate->region) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" class="form-control @error('effective_from') is-invalid @enderror" 
                                           ...
                                           value="{{ old('effective_from', $taxRate->effective_from ? $taxRate->effective_from->format('Y-m-d') : '') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" class="form-control @error('effective_to') is-invalid @enderror" 
                                           ...
                                           value="{{ old('effective_to', $taxRate->effective_to ? $taxRate->effective_to->format('Y-m-d') : '') }}">
                                    @error('effective_to')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <a href="{{ route('rates.show', $taxRate) }}" class="btn btn-secondary">
                                        Cancel
                                    </a>
                                </div>
                            </div>
